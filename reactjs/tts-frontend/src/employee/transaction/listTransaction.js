...
export default class TransactionForm extends React.Component {
  ...
  render() {
      ...
      return (
        ...
        <GiHistogram style = {{fontSize: '24px', marginLeft: '10px'}}/><strong style = {{marginLeft: '30px', fontFamily: 'Segoe UI', fontSize: '20px', textDecoration: 'underline overline'}}>Lịch sử giao dịch</strong>
        </div>
        <Card style={{borderStyle: 'none'}}>
          <CardHeader style={{backgroundColor: '#435d7d', textAlign: 'center', color: 'white', fontSize: '18px'}}>
            <strong></strong>
          </CardHeader>
          <CardBody style={{borderStyle: 'ridge', borderColor: '#435d7d', minHeight: '800px'}}>
            <FormGroup row>
