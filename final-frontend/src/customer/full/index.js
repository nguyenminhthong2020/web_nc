...
function Full() {
  return (
    <div>
          ...
          <div className="col-md-8 order-md-last">
            <div className="row">
              <div className="col-md-6 text-center">
                <a className="navbar-brand" href="/"><small>Ngân hàng trực tuyến</small>TTS <span>iB@nking</span> </a>
              </div>
      ...
      <section className="hero-wrap" style={{backgroundImage: 'url("images/bg_1.jpg")'}} data-stellar-background-ratio="0.5">
              ...
              <div className="row no-gutters slider-text align-items-center">
                <div className="col-md-8 ftco-animate d-flex align-items-end">
                  <div className="text w-100">
                    ...
                    <p><a href="#" className="btn btn-primary py-3 px-4">View All Books</a> <a href="#" className="btn btn-white py-3 px-4">Explore Now</a></p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="row">
                  ...
                  <div className="services-2 text-center">
                    <div className="icon-wrap">
                      <div className="icon d-flex align-items-center justify-content-center">
                        <span className="flaticon-fantasy" />
                      </div>
                    </div>
                ...
                <div className="col-md-3 d-flex align-items-stretch ftco-animate">
                  <div className="services-2 text-center">
                    <div className="icon-wrap">
                      <div className="icon d-flex align-items-center justify-content-center">
                        <span className="flaticon-history" />
                      </div>
                    </div>
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-6 col-lg-3 justify-content-center counter-wrap ftco-animate">
                  <div className="block-18 py-4 mb-4">
                    <div className="text align-items-center">
                      <strong className="number" data-number={75678}>0</strong>
                ...
                <div className="col-md-6 col-lg-3 justify-content-center counter-wrap ftco-animate">
                  <div className="block-18 py-4 mb-4">
                    <div className="text align-items-center">
                      <strong className="number" data-number={3040}>0</strong>
                ...
                <div className="col-md-6 col-lg-3 justify-content-center counter-wrap ftco-animate">
                  <div className="block-18 py-4 mb-4">
                    <div className="text align-items-center">
                      <strong className="number" data-number={283}>0</strong>
                ...
                <div className="col-md-6 col-lg-3 justify-content-center counter-wrap ftco-animate">
                  <div className="block-18 py-4 mb-4">
                    <div className="text align-items-center">
                      <strong className="number" data-number={14500}>0</strong>
          ...
          <section className="ftco-section">
            <div className="container">
              <div className="row">
                <div className="col-md-6 img img-3 d-flex justify-content-center align-items-center" style={{backgroundImage: 'url(images/about-1.jpg)'}}>
                </div>
              ...
              <div className="row">
                <div className="col-md-6 col-lg-4 d-flex">
                  <div className="book-wrap d-lg-flex">
                    <div className="img d-flex justify-content-end" style={{backgroundImage: 'url(images/book-1.jpg)'}}>
                      <div className="in-text">
                        <a href="#" className="icon d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="left" title="Add to cart">
                          <span className="flaticon-shopping-cart" />
                        </a>
                        <a href="#" className="icon d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="left" title="Add to Wishlist">
                          <span className="flaticon-heart-1" />
                        </a>
                        <a href="#" className="icon d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="left" title="Quick View">
                          <span className="flaticon-search" />
                        </a>
                        <a href="#" className="icon d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="left" title="Compare">
                          <span className="flaticon-visibility" />
                        </a>
                      </div>
                    </div>
                    <div className="text p-4">
                      <p className="mb-2"><span className="price">$12.00</span></p>
                      <h2><a href="#">You Are Your Only Limit</a></h2>
                      <span className="position">By John Nathan Muller</span>
                    </div>
                  </div>
                </div>
                <div className="col-md-6 col-lg-4 d-flex">
                  <div className="book-wrap d-lg-flex">
                    <div className="img d-flex justify-content-end" style={{backgroundImage: 'url(images/book-2.jpg)'}}>
                      <div className="in-text">
                        <a href="#" className="icon d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="left" title="Add to cart">
                          <span className="flaticon-shopping-cart" />
                        </a>
                    ...
                    <div className="text p-4">
                      <p className="mb-2"><span className="price sale">$12.00</span> <span className="price">$8.00</span></p>
                ...
                <div className="col-md-6 col-lg-4 d-flex">
                  <div className="book-wrap d-lg-flex">
                    <div className="img d-flex justify-content-end" style={{backgroundImage: 'url(images/book-3.jpg)'}}>
                      <div className="in-text">
                        <a href="#" className="icon d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="left" title="Add to cart">
                          <span className="flaticon-shopping-cart" />
                        </a>
                ...
                <div className="col-md-6 col-lg-4 d-flex">
                  <div className="book-wrap d-lg-flex">
                    <div className="img d-flex justify-content-end" style={{backgroundImage: 'url(images/book-4.jpg)'}}>
                      <div className="in-text">
                        <a href="#" className="icon d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="left" title="Add to cart">
                          <span className="flaticon-shopping-cart" />
                        </a>
                    ...
                    <div className="text p-4 order-md-first">
                      <p className="mb-2"><span className="price">$9.00</span></p>
                ...
                <div className="col-md-6 col-lg-4 d-flex">
                  <div className="book-wrap d-lg-flex">
                    <div className="img d-flex justify-content-end" style={{backgroundImage: 'url(images/book-5.jpg)'}}>
                      <div className="in-text">
                        <a href="#" className="icon d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="left" title="Add to cart">
                          <span className="flaticon-shopping-cart" />
                        </a>
                    ...
                    <div className="text p-4 order-md-first">
                      <p className="mb-2"><span className="price">$20.00</span></p>
                ...
                <div className="col-md-6 col-lg-4 d-flex">
                  <div className="book-wrap d-lg-flex">
                    <div className="img d-flex justify-content-end" style={{backgroundImage: 'url(images/book-6.jpg)'}}>
                      <div className="in-text">
                        <a href="#" className="icon d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="left" title="Add to cart">
                          <span className="flaticon-shopping-cart" />
                        </a>
          ...
          <section className="ftco-section testimony-section ftco-no-pb">
            <div className="img img-bg border" style={{backgroundImage: 'url(images/bg_4.jpg)'}} />
            <div className="overlay" />
            <div className="container">
                ...
                <div className="col-md-4 d-flex ftco-animate">
                  <div className="blog-entry justify-content-end">
                    <div className="text text-center">
                      ...
                      <h3 className="heading mb-3"><a href="#">New Friends With Books</a></h3>
                      <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-sm-12 col-md">
                  <div className="ftco-footer-widget mb-4 ml-md-4">
                    ...
                    <ul className="list-unstyled">
                      <li><a href="#"><span className="fa fa-chevron-right mr-2" />Affiliate Program</a></li>
                      <li><a href="#"><span className="fa fa-chevron-right mr-2" />Business Services</a></li>
                      <li><a href="#"><span className="fa fa-chevron-right mr-2" />Education Services</a></li>
                      <li><a href="#"><span className="fa fa-chevron-right mr-2" />Gift Cards</a></li>
                    </ul>
                  </div>
                </div>
                <div className="col-sm-12 col-md">
                  <div className="ftco-footer-widget mb-4 ml-md-4">
                    ...
                    <ul className="list-unstyled">
                      <li><a href="#"><span className="fa fa-chevron-right mr-2" />Join us</a></li>
                      <li><a href="#"><span className="fa fa-chevron-right mr-2" />Blog</a></li>
                      <li><a href="#"><span className="fa fa-chevron-right mr-2" />Privacy &amp; Policy</a></li>
                ...
                <div className="col-sm-12 col-md">
                  <div className="ftco-footer-widget mb-4">
                    ...
                    <ul className="list-unstyled">
                      ...
                      <li><a href="#"><span className="fa fa-chevron-right mr-2" />Careers</a></li>
                    </ul>
                  </div>
                </div>
                <div className="col-sm-12 col-md">
